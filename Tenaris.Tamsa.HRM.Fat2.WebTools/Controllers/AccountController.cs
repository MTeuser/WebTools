...
namespace Tenaris.Tamsa.HRM.Fat2.WebTools.Controllers
{
    ...
    public class AccountController : Controller
    {
        //
        // GET: /Account/Login
        private DataAccess.AusV1.DataAccess DataAccess = new DataAccess.AusV1.DataAccess();
        ...
        public ActionResult Login(LoginModel model, string returnUrl)
        {
            if (ModelState.IsValid)                
            {
                try
                {
                    Tenaris.Tamsa.HRM.Fat2.DataAccess.AusV1.User user = DataAccess.Login(model.UserName, model.Password);
